...
export default function Contact() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: 'Email',
      details: ['support@micromerce.com', 'sales@micromerce.com'],
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Standard shipping takes 5-7 business days, while express shipping takes 1-2 business days. International shipping may take 7-14 business days.'
    },
    {
            ...
            >
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Get help with your orders, returns, and account issues.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Share your thoughts and help us improve our service.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-8">
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  ...
                  <p>• Live Chat: Real-time support</p>
                </div>
              </div>
            </motion.div>
          </div>
